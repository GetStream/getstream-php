...
( cd $SOURCE_PATH ; make openapi ; make -C tools/openapi build ; ./build/openapi generate-client --language php --spec ./releases/v2/serverside-api.yaml --output $DST_PATH )

# Generate webhook conformance fixtures
( cd $SOURCE_PATH ; ./build/openapi generate-webhook-fixtures --output ../getstream-php/tests/fixtures/webhooks )
