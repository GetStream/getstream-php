...
( cd $SOURCE_PATH ; make openapi ; ./build/chat-manager openapi generate-client --language php --spec ./releases/v2/serverside-api.yaml --output $DST_PATH )

# Generate webhook conformance fixtures
( cd $SOURCE_PATH ; ./build/chat-manager openapi generate-webhook-fixtures --output ../getstream-php/tests/fixtures/webhooks )
