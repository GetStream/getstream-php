 ...
 * 
 */
class PushProvider implements JsonSerializable
{
    ...
    public function jsonSerialize(): array
    {
        return array_filter([
            ...
            'apn_notification_template' => $this->apnNotificationTemplate,
            ...
            'push_templates' => $this->pushTemplates,
        ], fn($v) => $v !== null);
    }
    ...
    public static function fromJson($json): self
    {
        ...
        return new static(createdAt: $json['created_at'] ?? null,
            ...
            apnNotificationTemplate: $json['apn_notification_template'] ?? null,
            ...
            pushTemplates: $json['push_templates'] ?? null
        );
    }
} 
