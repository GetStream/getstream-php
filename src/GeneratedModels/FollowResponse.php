 ...
 * @property string $followerRole
 * @property string $pushPreference
 * @property string $status
 * @property \DateTime $updatedAt
 * @property FeedResponse $sourceFeed
 * @property FeedResponse $targetFeed
 * @property \DateTime|null $requestAcceptedAt
 * @property \DateTime|null $requestRejectedAt
